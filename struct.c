...
/* equality test */
if(st3.lastName!=st2.lastName)//st3.lastName와st2.lastName비교
   printf("st3와 st2는 다르다");
else if(st3.studentId!=st2.studentId)//st3.studentId와st2.studentId 비교
    printf("st3와 st2는 다르다");
else if(st3.grade!=st2.grade)//st3.grade와st2.grade 비교
    printf("st3와 st2는 다르다");
else
   printf("st3와 st2는 같다");
}